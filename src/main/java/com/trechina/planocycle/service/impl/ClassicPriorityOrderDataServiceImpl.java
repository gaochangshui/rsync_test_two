...
//            );
    ...
    public Map<String, Object> getAttrName(EnterpriseAxisDto enterpriseAxisDto) {
        ...
        List<Map<String, Object>> attrName = priorityOrderDataMapper.selectPriorityAttrName(tableNameAttr,isCompanyCd,prodIsCore);
        List<Map<String, Object>> stratumName = priorityOrderDataMapper.selectPriorityStratumName(tableName,isCompanyCd,prodIsCore);
        list.add(attrName);
