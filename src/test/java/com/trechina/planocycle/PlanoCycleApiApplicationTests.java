...
class PlanoCycleApiApplicationTests {
    ...
    public  void test7(){
        ...
        List<Map<String, Object>> allData = productPowerDataMapper.getSyokikaAllData(companyCd,
                janInfoTableName, "\""+attrColumnMap.get("jan_cd")+"\"", janClassifyList,authorCd,1,null,null,null);
    }


    @Test
    public  void test8()  {
        //String emailHost = "";  //发件人主机
        //String transportType = ""; //发送协议
        //String fromUser = ""; //发件人名称
        //String fromEmail = ""; //发件人邮箱
        //String authCode = ""; //发件人邮箱授权码
        //try {
